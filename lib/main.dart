...
import 'package:iot_project/Navbar/Navbar.dart';
...
class ChartDashRoute extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    properties.forEach((key, value) {
      if(key == 'alg_name') {
        displayItems.add(Text(value));
      } else {
        displayItems.add(Text('$key: $value'));
      }
    });
                    ...
                    child: Column(
                      children: [
                        ...
                        TextButton(
                          ...
                          onPressed: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => ProviderScope(child: ChartDashRoute(properties: properties,))));
                          },
                        )
                      ],
                    ),
